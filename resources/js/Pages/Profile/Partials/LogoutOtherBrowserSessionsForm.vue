    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                全ての端末からログアウトする。最近のセッションは下記のとおりです。※下記は一部表示されていない可能性があります。心配であればパスワードを更新してください。                
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">この端末</span>
                                <span v-else>最終ログイン {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    他のブラウザセッションからログアウトするためにはパスワードが必要です。
